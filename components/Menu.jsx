                    ...
                    <Row>
                        <Col sm={6} className={"d-flex"}>
                            <div className="menu-desktop__logo">
                                <Link prefetch={true} href={"/"}><img src="/images/static/logo.svg" alt=""/></Link>
                            </div>
                            ...
                            <div className="menu-desktop__items">
                                ...
                                <div className="menu-desktop__items__inner-sub">
                                    <ul>
                                        <li><Link prefetch={true} href={"/services/detail"}>Insight & Strategy <img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                        <li><Link prefetch={true} href={"/services/detail"}>SEO <img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                        <li><Link prefetch={true} href={"/services/detail"}>Social Media Marketing <img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                        <li><Link prefetch={true} href={"/services/detail"}>PPC <img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                    </ul>

                                    <ul>
                                        <li><Link prefetch={true} href={"/services/detail"}>Insight & Strategy 2<img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                        <li><Link prefetch={true} href={"/services/detail"}>SEO <img
                                            src="/images/static/arrow-right-white.svg"
                                    ...
                                    <ul>
                                        <li><Link prefetch={true} href={"/services/detail"}>Insight & Strategy 3<img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                        <li><Link prefetch={true} href={"/services/detail"}>SEO <img
                                            src="/images/static/arrow-right-white.svg"
                                ...
                                <div className="menu-desktop__items__slide">
                                    <ul className={"open-menu"}>
                                        <li><Link prefetch={true} href={"/"}>Home <img src="/images/static/arrow-right-white.svg"
                                                                     alt=""/></Link></li>
                                        <li><Link prefetch={true} href={"/about"}>About Us <img src="/images/static/arrow-right-white.svg"
                                                                              alt=""/> </Link></li>
                                        <li><Link prefetch={true} href={"/project"}>Portfolios <img
                                            src="/images/static/arrow-right-white.svg"
                                            alt=""/></Link></li>
                                    </ul>
                                    ...
                                    <div className="menu-desktop__items__slide__subs as-join">
                                        <ul>
                                            <li><Link prefetch={true} href={"/career"}>Join us <img
                                                src="/images/static/arrow-right-white.svg"
                                                alt=""/></Link>
                                            </li>
                                        </ul>
                        ...
                        <Col sm={6} className={"menu-desktop__contact"}>
                            <Link prefetch={true} href={"/contact"}>Contact us <img src="/images/static/arrow-right-white.svg"
                                                                  alt=""/></Link>
                        </Col>
                    </Row>
                </Container>
