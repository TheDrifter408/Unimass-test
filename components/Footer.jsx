                ...
                <Row>
                    ...
                    <Col sm={12}>
                        <div className={"footer__menu"}>
                            <ul>
                                <li><Link prefetch={true} href={'/'}>Organic Marketing</Link></li>
                                <li><Link prefetch={true} href={'/'}>Paid Marketing</Link></li>
                                <li><Link prefetch={true} href={'/'}>Creative Design</Link></li>
                                <li><Link prefetch={true} href={'/'}>Web Design</Link></li>
                                <li><Link prefetch={true} href={'/'}>Copy Writing</Link></li>
                                <li><Link prefetch={true} href={'/'}>Visual Arts</Link></li>
                            </ul>
                        </div>
